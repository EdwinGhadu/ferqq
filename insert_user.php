...
<?php
if(isset($_POST['username']) && isset($_POST['user_email']) && isset($_POST['user_password']) && isset($_POST['user_phone_number'])){

// CHECK IF FIELDS ARE NOT EMPTY
    if(!empty(trim($_POST['username'])) && !empty(trim($_POST['user_phone_number'])) && !empty(trim($_POST['user_email'])) && !empty($_POST['user_password'])){
...
// Escape special characters.
        ...
        $user_phone_number = mysqli_real_escape_string($db_connection, htmlspecialchars($_POST['user_phone_number']));
...
// INSER USER INTO THE DATABASE
                $insert_user = mysqli_query($db_connection, "INSERT INTO `users` (username, user_email, user_password, user_phone_number) VALUES ('$username', '$user_email', '$user_hash_password' , '$user_phone_number')");
