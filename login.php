<?php
if(isset($_POST['user_email'])  && isset($_POST['user_phone_number']) && isset($_POST['user_password'])){

// CHECK IF FIELDS ARE NOT EMPTY
    if(!empty(trim($_POST['user_email'])) && !empty(trim($_POST['user_phone_number']))  && !empty(trim($_POST['user_password']))){
